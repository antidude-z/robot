...
try:
    while True:
        ...
        undistorted_image = cv2.fisheye.undistortImage(frame, K, D, Knew=new_K)

        # undistorted_image = undistorted_image[86:873, 246:1033]

        # Отображаем кадр в окне
        cv2.imshow('IP Camera Stream', undistorted_image)
